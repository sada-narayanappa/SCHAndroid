				...
				Thread poster= new Thread(new Runnable()
				{
					public void run()
					{
						...
						for(int i = 0; i < tempSize; i++)
						{
							...
							data.add(new BasicNameValuePair("NO2", Float.toString(tempData.NO2)));//add humidity
							...
							data.add(new BasicNameValuePair("dateRecorded",tempData.date.substring(0,tempData.date.indexOf(","))));
							data.add(new BasicNameValuePair("timeRecorded", tempData.date.substring(tempData.date.indexOf(","))+1));
							...
							try {
								while((line=br.readLine())!=null){//Year-Month-Day,Hour:Minute:Second,Temperature,Humidity,Latitude,Longitude,Speed
									if(!(line.substring(0,4).equals("Year"))){
										...
										data.add(new BasicNameValuePair("id",android_id));
										data.add(new BasicNameValuePair("api_key", "1"));
										data.add(new BasicNameValuePair("dateRecorded",readData[0]));
										data.add(new BasicNameValuePair("timeRecorded",readData[1]));
										data.add(new BasicNameValuePair("temperature",readData[2]));
										data.add(new BasicNameValuePair("humidity",readData[3]));
										data.add(new BasicNameValuePair("lat",readData[4]));
										data.add(new BasicNameValuePair("lon",readData[5]));
										data.add(new BasicNameValuePair("veloc",readData[6]));
										data.add(new BasicNameValuePair("NO2",readData[7]));
										data.add(new BasicNameValuePair("O3",readData[8]));
										data.add(new BasicNameValuePair("api_key", "1"));
										PostToServer postMan=new PostToServer();
							...
							try {
								while((line=br.readLine())!=null){//use split method
									if(!(line.substring(0,4).equals("Year"))){
										...
										filedata.add(new BasicNameValuePair("dateRecorded",readData[0]));
										filedata.add(new BasicNameValuePair("timeRecorded",readData[1]));
										filedata.add(new BasicNameValuePair("htype", "attack"));
										filedata.add(new BasicNameValuePair("solution",readData[2]));
										filedata.add(new BasicNameValuePair("severity",readData[3]));
										filedata.add(new BasicNameValuePair("unusualConditions",readData[4]));
										filedata.add(new BasicNameValuePair("lat",readData[5]));
										filedata.add(new BasicNameValuePair("lon",readData[6]));
										filedata.add(new BasicNameValuePair("velocity",readData[7]));
							...
							try {
								while((line=br.readLine())!=null){//use split method
									if(!(line.substring(0,4).equals("Year"))){
										...
										filedata.add(new BasicNameValuePair("dateRecorded",readData[0]));
										filedata.add(new BasicNameValuePair("timeRecorded",readData[1]));
										filedata.add(new BasicNameValuePair("medicationName",readData[2]));
										filedata.add(new BasicNameValuePair("MedicationDose",readData[3]));
										filedata.add(new BasicNameValuePair("Lat",readData[4]));
										filedata.add(new BasicNameValuePair("Lon",readData[5]));
										filedata.add(new BasicNameValuePair("Velocity",readData[6]));
							...
							try {
								while((line=br.readLine())!=null){//use split method
									if(!(line.substring(0,4).equals("Year"))){
										...
										filedata.add(new BasicNameValuePair("fev",readData[2]));
										filedata.add(new BasicNameValuePair("pef",readData[3]));
										filedata.add(new BasicNameValuePair("Lat",readData[4]));
										filedata.add(new BasicNameValuePair("Lon",readData[5]));
										filedata.add(new BasicNameValuePair("Velocity",readData[6]));
										PostToServer filepostMan=new PostToServer();
