				...
				.setPositiveButton("Yes",new DialogInterface.OnClickListener(){
					public void onClick(DialogInterface arg0, int arg1) {
						...
						try{
							...
							final String tempData=","+medicationName+"\r\n";
							...
							if(mWifi.isConnected()){
								Thread submitMed=new Thread(new Runnable()
							    {
							        ...
							        {     
							        	...
							        	data.add(new BasicNameValuePair("remaining", tempData));
							        	PostToServer postMan=new PostToServer();
						                final String temp=postMan.postResults(data,"http://mscs-php.uwstout.edu/geoinet/EBPHPCode/medicationParse.php");
							        }
							    });
								submitMed.start();
							}
								...
								if(file2.exists()){
									...
									fw.write("Year-Month-Day,Hour:Minute:Second,Medication Name\r\n");//add the information as to what is between each comma.
									fw.write(date+tempData);
									fw.close();
								}
							}
				...
				.setPositiveButton("Yes",new DialogInterface.OnClickListener(){
					public void onClick(DialogInterface arg0, int arg1) {
						...
						try 
						{
							...
							int sol = spinner.getSelectedItemPosition();//0-inhaler,1-Med,2-PaperBag,3-Other
							...
							final String date = new SimpleDateFormat("yyyy-MM-dd,HH:mm:ss").format(new Date());
							final String tempString=","+tempsol+","+severity+","+descript+"\r\n";
							ConnectivityManager connManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
							NetworkInfo mWifi = connManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI);
							if(mWifi.isConnected()){
								Thread submitAttack=new Thread(new Runnable()
							    {
							        ...
							        {     
							        	...
							        	data.add(new BasicNameValuePair("id",android_id ));
							        	data.add(new BasicNameValuePair("date", date));
							        	data.add(new BasicNameValuePair("remaining", tempString));
							        	PostToServer postMan=new PostToServer();
						                final String temp=postMan.postResults(data,"http://mscs-php.uwstout.edu/geoinet/EBPHPCode/attackParse.php");
							        }
							    });
								submitAttack.start();
							}
							...
							if(file2.exists()){
								...
								FileWriter fw=new FileWriter(file2,false);
								fw.write("Year-Month-Day,Hour:Minute:Second, Solution, Severity, Unusual Conditions\r\n");//add the information as to what is between each comma.
								fw.write(date+tempString);
								fw.close();
							}
							}
	                                    	...
	                                    	if(data.length()>=20){
	                            				...
	                            				.setPositiveButton("Yes",new DialogInterface.OnClickListener(){
	                            					public void onClick(DialogInterface arg0, int arg1) {
	                            						...
	                            						try{
	                            							final String date = new SimpleDateFormat("yyyy-MM-dd,HH:mm:ss").format(new Date());
	                            							final String remainingString=fev+", "+pef2+"\r\n";
	                            							ConnectivityManager connManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
	                            							NetworkInfo mWifi = connManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI);
	                            							if(mWifi.isConnected()){
	                            								Thread submitAttack=new Thread(new Runnable()
	                            							    {
	                            							        ...
	                            							        {     
	                            							        	...
	                            							        	data.add(new BasicNameValuePair("id",android_id ));
	                            							        	data.add(new BasicNameValuePair("date", date));
	                            							        	data.add(new BasicNameValuePair("remaining", remainingString));
	                            							        	PostToServer postMan=new PostToServer();
	                            						                final String temp=postMan.postResults(data,"http://mscs-php.uwstout.edu/geoinet/EBPHPCode/peakFlowParse.php");
	                            							        }
	                            							    });
	                            								submitAttack.start();
	                            							}
	                            							...
	                            							if(file2.exists()){
	                            								...
	                            								FileWriter fw=new FileWriter(file2,false);
	                            								fw.write("Year-Month-Day,Hour:Minute:Second, FEV1, PEF\r\n");
	                            								fw.write(tempString);
	                            								fw.close();
	                            							}
	                            							}
